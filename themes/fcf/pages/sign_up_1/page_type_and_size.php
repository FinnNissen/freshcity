	...
	<div class="wrap">
		...
		<div class="genbox four-col" id="veggie-bag">
			...
			<div class="required fieldrow radio-row">
				<label for="veggie-small"><input type="radio" id="veggie-small" name="type-and-size" value="Veggie Small"> Small, $27<sup>.99</sup></label>
				<label for="veggie-large"><input type="radio" id="veggie-large" name="type-and-size" value="Veggie Large"> Large, $37<sup>.99</sup></label>
			</div>
			<p>The Veggie Bag contains 8 to 12 types of vegetables. Our salad greens are usually harvested the day off or the day before delivery ensuring the freshest produce.</p>
		</div>
		<div class="genbox four-col" id="veggie-fruit-bag">
			...
			<div class="required fieldrow radio-row">
				<label for="veggie-fruit-small"><input type="radio" id="veggie-fruit-small" name="type-and-size" value="Veggie & Fruit Small"> Small, $27<sup>.99</sup></label>
		...
		<div class="genbox four-col" id="fruit-bag">
			...
			<div class="required fieldrow radio-row">
				<label for="fruit-small"><input type="radio" id="fruit-small" name="type-and-size" value="Fruit Small"> Small, $27<sup>.99</sup></label>
