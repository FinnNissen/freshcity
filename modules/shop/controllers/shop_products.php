<?
	...
	class Shop_Products extends Backend_Controller
	{
		...
		public $list_search_fields = array('@name', 'sku', '(select group_concat(sku) from shop_products sku_list where sku_list.product_id is not null and sku_list.product_id=@id)', '(select group_concat(sku) from shop_option_matrix_records where product_id=@id)');
