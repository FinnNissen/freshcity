	...
	class Shop_FirstData_Api_Payment extends Shop_PaymentType
	{
		...
		public function process_payment_form($data, $host_obj, $order, $back_end = false)
		{
			...
			try
			{
				...
				Core_Xml::create_dom_element($document, $creditcard, 'cardexpmonth', $expMonth);
				Core_Xml::create_dom_element($document, $creditcard, 'cardexpyear', $expYear);
				...
				Core_Xml::create_dom_element($document, $billing, 'name', $validation->fieldValues['FIRSTNAME'].' '.$validation->fieldValues['LASTNAME']);
				Core_Xml::create_dom_element($document, $billing, 'company', $order->billing_company);
				Core_Xml::create_dom_element($document, $billing, 'address1', $order->billing_street_addr);
				...
				Core_Xml::create_dom_element($document, $billing, 'zip', $order->billing_zip);
				Core_Xml::create_dom_element($document, $billing, 'country', $order->billing_country->code);
				Core_Xml::create_dom_element($document, $billing, 'email', $order->billing_email);
				Core_Xml::create_dom_element($document, $billing, 'phone', $order->billing_phone);
				...
				Core_Xml::create_dom_element($document, $shipping, 'name', $order->shipping_first_name.' '.$order->shipping_last_name);
				Core_Xml::create_dom_element($document, $shipping, 'address1', $order->shipping_street_addr);
				...
				Core_Xml::create_dom_element($document, $trans_details, 'ponumber', $order->billing_phone);
