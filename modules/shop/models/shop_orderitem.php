<?php
	...
	class Shop_OrderItem extends Db_ActiveRecord
	{
		 ...
		 */
		public function output_product_name($output_name = true, $as_plain_text = false, $no_tax_incl = false, $extra_details = false, $options_delimiter = '; ', $lowercase_options = true)
		{
