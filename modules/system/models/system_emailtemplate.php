	...
	class System_EmailTemplate extends Db_ActiveRecord 
	{
		...
		public function send_to_customer($customer, $message_text, $sender_email = null, $sender_name = null, $customer_email = null, $customer_name = null, $custom_data = null)
		{
			try
			{
				...
				Core_Email::send('system', 'email_message', $viewData, $subject, $customer_name, $customer_email, array(), $settings_obj, $reply_to);

				Backend::$events->fireEvent('core:onAfterEmailSendToCustomer', $customer, $this->subject, $message_text, $customer_email, $customer_name, $custom_data, $reply_to, $this);
			}
			catch (exception $ex)
			{
			}
		 ...
		 */
		private function event_onAfterEmailSendToCustomer($customer, $subject, $message_text, $customer_email, $customer_name, $custom_data, $reply_to, $template) {}
